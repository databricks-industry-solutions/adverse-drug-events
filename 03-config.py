...
# MAGIC %md
# MAGIC You have access to `SolAccUtil` class. By initializing this class, you create paths where you store raw data (in the cloud), root path for your delta tables and download data for testing.
